              ...
              <div className="space-y-4 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-start space-y-3">
                  <Link
                    ...
                    className="opacity-70 font-light transition-opacity hover:opacity-100 hover:font-thin hover:text-gray-400"
                  >
                    Documentation
                  </Link>
                  <Link
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-8 md:mt-12 pt-8 ">
          ...
          <div className="flex space-x-6 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-70 transition-opacity hover:opacity-100 hover:text-gray-400"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-70 font-light transition-opacity hover:opacity-100 hover:text-gray-400"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
