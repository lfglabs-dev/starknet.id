              ...
              <div className="space-y-4 lg:mr-[-120px] md:ml-[55px] mr-0">
                ...
                <div className="flex flex-col space-y-3">
                  <Link
                    ...
                    className="opacity-130 hover:opacity-60 font-light transition-opacity duration-300"
                  >
                    Documentation
                  </Link>
                  <Link
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 pt-8">
          ...
          <div className="flex space-x-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-130 hover:opacity-60 transition-opacity duration-300"
            >
