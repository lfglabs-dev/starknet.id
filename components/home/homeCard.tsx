...
const HomeCard: FunctionComponent<HomeCardProps> = ({
  ...
  return (
    <div className="w-full overflow-hidden bg-white max-w-[864px]  flex items-stretch justify-between flex-wrap mt-2 mb-2  text-left text-inherit no-underline rounded-lg shadow-custom  transition-all duration-150 ease-in-out bg-background-light z-10">
